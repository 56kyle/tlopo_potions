...
class NotAnActualException(BaseException):
    pass
...
class Board:
    ...
    def __init__(self,  potion, win=Window(), pattern=(RED, RED, GREEN, GREEN, BLUE, BLUE, RED, None)):
        self.potion = potion
        self.win = win
    ...
    def complete(self):
        if not keyboard.is_pressed("`"):
            ...
            raise NotAnActualException("This is not a real error. Just making sure that the program certainly stops.")
